package com.mc7.konvertersuhuapp
...
import com.mc7.konvertersuhuapp.ui.theme.KonverterSuhuAppTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            KonverterSuhuAppTheme {
                KonverterSuhuApp()
            }
        }
    }
